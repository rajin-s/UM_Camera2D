...
namespace UModules
{
    ...
    public class CameraMovement : ExtendedBehaviour
    {
        ...
        /// <summary>
        /// Base asymptotic speed for camera motion
        /// </summary>
        ...
        /// <summary>
        /// Get CameraFocus and CameraArea components
        /// </summary>
        ...
        /// <summary>
        /// Update the camera's properties through CameraExtension
        /// </summary>
        /// <access>protected void</access>
        protected void LateUpdate()
        {
            Vector2 finalPosition = transform.position;
            float finalSpeed = baseSpeed, finalZoom = float.NaN, finalPull = float.NaN;
            ...
            Vector2 movePosition = Vector2.Lerp(extension.Pan, finalPosition, Time.deltaTime * finalSpeed);
            if (!(float.IsNaN(finalZoom) && float.IsNaN(finalPull)))
            {
                extension.Zoom = Mathf.Lerp(extension.Zoom, finalZoom, Time.deltaTime * finalSpeed);
                extension.Pull = Mathf.Lerp(extension.Pull, finalPull, Time.deltaTime * finalSpeed);
            }
